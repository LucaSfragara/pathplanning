...
x_curr =  0#center of wheel base radius from center when you start
y_curr = 0
theta_curr = 0
...
if __name__ == "__main__":
    ...
    #while odometry.get_theta() < math.pi/2:
    while time.time() - start_time < 5:
        ...
        left_motor.velocity_command = -7
        right_motor.velocity_command = 7
        odometry.update_and_print(time.time() - prev_time)
        prev_time = time.time()
        dist = read_data()
